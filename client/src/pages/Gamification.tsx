...
import { Trophy, Star, Zap, Flame, Dumbbell, TrendingUp, Lock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="px-5 pt-12 pb-4">
        <h1 className="text-2xl font-display font-bold text-foreground mb-1">Achievements</h1>
        <p className="text-muted-foreground text-sm">{earnedCount}/{ALL_ACHIEVEMENTS.length} unlocked</p>
      </div>
